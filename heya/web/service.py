...
from heya.application import convert, convert_md, convert_wechat
...
from heya.web.converters.batch_converter import BatchConverter
from heya.web.converters.html_converter import HtmlConverter
from heya.web.converters.markdown_converter import MarkdownConverter
from heya.web.converters.wechat_converter import WechatConverter
...
class WebConvertService:
    ...
    def convert_html_stream(
        ...
        try:
            yield from self._batch_converter.convert_stream(
                sources=urls,
    ...
    def convert_markdown_stream(
        ...
        try:
            yield from self._markdown_converter.convert_stream(
                sources=md_files,
                progress_update_fn=progress_update_fn,
                timeout=timeout,
                quality=quality,
    ...
    def convert_wechat(
        ...
        try:
            result = self._wechat_converter.convert(
                source=url,
                target=output_dir,
                timeout=timeout,
                quality=quality,
    ...
    def convert_wechat_stream(
        ...
        try:
            yield from self._wechat_converter.convert_stream(
                sources=[url],
                progress_update_fn=progress_update_fn,
                timeout=timeout,
                quality=quality,
