...
from heya.core.exceptions import MarkdownError
from heya.core.template.html_template import render_html
from heya.core.config import MarkdownConfig, load_config
...
class MarkdownProcessor:
    def __init__(
        ...
        self._config = config or load_config().markdown
